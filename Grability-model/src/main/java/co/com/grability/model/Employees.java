 ...
 */
package co.com.grability.model;
...
public class Employees implements Serializable {
    ...
    @SequenceGenerator(name = "EMPLOYEES_SEQ",sequenceName = "EMPLOYEES_SEQ", initialValue = 1, allocationSize = 1)
    ...
    public String toString() {
        return "co.com.grability.model.Employees[ employeeId=" + employeeId + " ]";
    }
